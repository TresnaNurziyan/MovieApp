package tresna.mobile.movieapps.searchmovie.presenter;
...
import tresna.mobile.movieapps.searchmovie.view.SearchView;
...
public class SearchPresenter extends BasePresenter<SearchView> {
    ...
    public void getItem(tresna.mobile.movieapps.searchmovie.model.ResultsItem item, Activity activity){
